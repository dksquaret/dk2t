...
int64 nChainStartTime = 1503312885;
...
const string strMessageMagic = "DKcoin²Ticket Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in DKcoin²Ticket
    bool fStrictPayToScriptHash = true; // Always active in DKcoin²Ticket
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "DKcoin²Ticket", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "CBigNum vector dkcoin²ticket empty mapBlockIndex dkcoin²ticket dkcoin²ticket";
        CTransaction txNew;
        ...
        block.nNonce   = !fTestNet ? 75636654 : 279540;
       ...
       // printf("block.nNonce = %u \n", block.nNonce);
		block.print();
        assert(block.hashMerkleRoot == uint256("0x22af063613fa353074a32391e2b94077c30b688554f3841a9f7f2d2de4121b74"));
...
unsigned char pchMessageStart[4] = { 0x74, 0x50, 0x40, 0x71 };
